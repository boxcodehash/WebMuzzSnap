...
- Entras con MetaMask o WalletConnect, firmas un nonce y el servidor comprueba que tengas al menos 10.000.000 MUZZ (`0xef3dAa5fDa8Ad7aabFF4658f1F78061fd626B8f0` en Ethereum). El mínimo se cambia con `MIN_MUZZ`.
